    ...
    <div className="bg-page-soft min-h-screen overflow-x-clip w-full">
      <div className="bg-brand-hero py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-dark-label text-sm font-semibold tracking-widest uppercase mb-2">Explore</p>
          <h1 className="font-display text-4xl font-bold text-dark-body">Our Properties</h1>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-20">
            ...
            <button
              ...
              className="mt-4 text-[#128C7E] font-medium hover:text-[#075E54]"
            >
              Clear all filters
            </button>
          </div>
